...
app.post("/upload/:id", upload.array("files", 5), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var files, paths;
    return __generator(this, function (_a) {
        files = req.files;
        paths = files.map(function (file) { return file.location; });
        res.send(paths);
        return [2 /*return*/];
    });
}); });
